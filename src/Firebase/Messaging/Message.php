 ...
 *
 * @phpstan-type MessageInputShape array{token?: non-empty-string, topic?: non-empty-string, condition?: non-empty-string, data?: (MessageData | array<non-empty-string, (Stringable | string)>), notification?: (Notification | NotificationShape), android?: AndroidConfigShape, apns?: (ApnsConfig | ApnsConfigShape), webpush?: (WebPushConfig | WebPushConfigShape), fcm_options?: (FcmOptions | FcmOptionsShape)}
