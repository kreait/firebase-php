...
class ValidatorTest extends FirebaseTestCase
{
    ...
    {
        $uri = $this->uri->withPath(str_pad('', (\Firebase\Database\Reference\Validator::MAX_DEPTH + 1) * 2, 'x/'));
    ...
    {
        $uri = $this->uri->withPath(str_pad('', \Firebase\Database\Reference\Validator::MAX_KEY_SIZE + 1, 'x'));
    ...
    {
        $invalid = str_shuffle(\Firebase\Database\Reference\Validator::INVALID_KEY_CHARS)[0];
